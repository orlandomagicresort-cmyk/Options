...
SUPABASE_URL = _get_secret("SUPABASE_URL", "https://iyiswgonnvknijrvsygb.supabase.co")
SUPABASE_KEY = _get_secret("SUPABASE_KEY", "sb_publishable_FvqdkEPQaKuDUznTFIlApg_5EG5RYYN")
